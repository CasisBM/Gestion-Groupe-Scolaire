...
CREATE TABLE IF NOT EXISTS `dbEtablissement`.`COMPTES` (
  ...
  `creation_compte` DATE NULL,
  `token` VARCHAR(255) NULL,
  `ELEVES_id_eleve` INT NOT NULL,
  `ENSEIGNANTS_id_enseignant` INT NOT NULL,
  PRIMARY KEY (`id_compte`),
  INDEX `fk_COMPTES_ELEVES1_idx` (`ELEVES_id_eleve` ASC) ,
  INDEX `fk_COMPTES_ENSEIGNANTS1_idx` (`ENSEIGNANTS_id_enseignant` ASC) ,
