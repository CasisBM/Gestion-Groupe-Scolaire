...
/* $requete = "select nom, prenom, id_promotion from eleves where id_eleve = ".$_GET['idPromotion'];
...
$requete = "select DATE_FORMAT(c.date, '%d/%m/%Y'), m.nom_matiere, c.heure_debut,c.heure_fin,s.nom_salle,en.nom,s.nom_salle 
            ...
            where c.id_promotion = $id_promotion";
...
?>
    <input type="date" min="2022-01-01" max="2025-01-01"/>
            ...
            <table>
              <thead>
                <tr>
                  <th class="nomTable" colspan="6">Planning Promotion (nom)</th>
                </tr>
                <tr>
                </tr>
            ...
            <tfoot>
              <tr >
                <td  colspan="6">
                  ...
                  > </div>
                  <button class="buttonTable" type="button" onclick="location.href='index.php?page=ajouterCoursPromotion&idPromotion=<?= $_GET['idPromotion'] ?>'" > Ajouter un cours </button></div>
                </td>
              </tr>
            </tfoot>
            </table> 
