...
<?php require './includes/header.php'; ?>
            ...
            <?php for ($i=0; $i <count($tblQuery) ; $i++) { ?>
              <tr>
                ...
                <td>Ecole 1</td>
                <td>
                <a href="index.php?page=editPromo&id=<?= $tblQuery[$i]['id_promotion'] ?>" ><i class="fa-solid fa-pen"></i></a>
                <a href="index.php?page=supp&pg=promo&id=<?= $tblQuery[$i]['id_promotion'] ?>"  onclick="return confirm('Vous ne pouvez pas supprimer cette promotion (eleves utilise ça) ?')"><i class="fa-solid fa-trash"></i></a> 
                </td>
              </tr>
              <?php } ?>
            </tbody>
